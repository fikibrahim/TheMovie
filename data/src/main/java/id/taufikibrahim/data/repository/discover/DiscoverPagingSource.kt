...
class DiscoverPagingSource @Inject constructor(var discoverRepository: DiscoverRepository, var genreId: Int) : PagingSource<Int, Discover>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Discover> {
        return try {
            ...
            val response = discoverRepository.getDiscoverByGenre(page = nextPageNumber, genreId)
