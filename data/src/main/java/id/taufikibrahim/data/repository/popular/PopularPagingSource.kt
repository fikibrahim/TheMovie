...
class PopularPagingSource @Inject constructor(var popularRepository: PopularRepository) : PagingSource<Int, Discover>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Discover> {
        return try {
            ...
            val response = popularRepository.getPopular(page = nextPageNumber)
